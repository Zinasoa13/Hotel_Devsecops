...
import LogoDarkUrl from './img/logo-dark.svg';
import LogoWhiteUrl from './img/logo-white.svg';

export const LogoDark = LogoDarkUrl;
export const LogoWhite = LogoWhiteUrl;
