...
/**
 * Check-in date field: react-datepicker bound to RoomContext (dateCheckIn/setDateCheckIn).
...
export default function CheckIn({
  ...
  const { dateCheckIn, setDateCheckIn } = useRoomContext();
  ...
  // When CheckOut opens, close CheckIn so only one calendar popover is visible.
  useEffect(() => {
